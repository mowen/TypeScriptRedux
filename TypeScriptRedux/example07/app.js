...
System.register(["react", "react-dom", "redux", "react-redux", "./Counter", "./ShapeViewer", "./ColorPicker"], function(exports_1, context_1) {
    "use strict";
    ...
    var React, ReactDOM, redux_1, react_redux_1, Counter_1, ShapeViewer_1, ColorPicker_1;
    ...
    return {
        ...
        execute: function() {
            ...
            ColorWrapper = react_redux_1.connect(function (state) { return ({ color: state.color }); }, function (dispatch) { return ({
                setColor: function (color) { return dispatch({ type: "COLOR_CHANGE", color: color }); }
            }); })(ColorWrapperBase);
            ReactDOM.render(React.createElement(react_redux_1.Provider, {store: store}, React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", {style: { width: 220 }}, React.createElement(Counter_1.default, {field: "width", step: 10}), React.createElement(Counter_1.default, {field: "height", step: 10}))))), React.createElement(ShapeViewer_1.default, null)), document.getElementById('content'));
        }
    }
});
