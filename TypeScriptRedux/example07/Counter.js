        ...
        execute: function() {
            Counter = (function (_super) {
                ...
                Counter.prototype.render = function () {
                    ...
                    return (React.createElement("div", null, React.createElement("p", null, React.createElement("label", null, field, ": "), React.createElement("b", null, "#", this.props.counter)), React.createElement("button", {style: { width: 30, margin: 2 }, onClick: function (e) { return _this.props.incr(field, step); }}, "+"), React.createElement("span", {style: { padding: "0 5px" }}), React.createElement("button", {style: { width: 30, margin: 2 }, onClick: function (e) { return _this.props.decr(field, step); }}, "-")));
                };
                return Counter;
            }(React.Component));
            ...
            mapDispatchToProps = function (dispatch) { return ({
                ...
                decr: function (field, step) {
                    dispatch({ type: 'COUNTER_CHANGE', field: field, by: step * -1 });
                }
            }); };
